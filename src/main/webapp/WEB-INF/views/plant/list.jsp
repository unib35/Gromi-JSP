    ...
    <div class="container">
        ...
        <div class="search-box">
            <form action="${pageContext.request.contextPath}/plant/search" method="get">
                <input type="text" name="keyword" placeholder="식물 이름, 학명, 키워드 검색..." required>
                <button type="submit">검색</button>
            </form>
        </div>
        
        <div class="recommendation-link">
            <a href="${pageContext.request.contextPath}/plant/recommend">나에게 맞는 식물 추천 받기</a>
        </div>
