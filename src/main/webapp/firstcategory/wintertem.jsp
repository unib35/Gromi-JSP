		...
		<div class="row">
			<div class="col-md-12 text-center mb-5">
				<h1 class="fw-bold"
					...
					<span style="color: green; text-decoration: underline;">겨울
						최저온도</span>를 찾고 있나요?
				</h1>
			</div>
			<div class="col-md-12 d-flex justify-content-center">
				<div class="d-flex justify-content-center">
					...
					<button
						...
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">0도
						이하</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">5도</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">7도</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">10도</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">13도
						이상</button>
					<button
						class="btn btn-primary btn-lg rounded-pill mx-2 custom-button"
						onclick="toggleButton(this)"
	...
	<script>
		function toggleButton(button) {
			...
			if (button.classList.contains('active')) {
				...
				} else if (buttonText === '0도 이하') {
					window.location.href = '../plantview.jsp';
				} else if (buttonText === '5도') {
					window.location.href = '../plantview.jsp';
				} else if (buttonText === '7도') {
					window.location.href = '../plantview.jsp';
				} else if (buttonText === '10도') {
					window.location.href = '../plantview.jsp';
				} else if (buttonText === '13도 이상') {
					window.location.href = '../plantview.jsp';
				}
			}
		}
