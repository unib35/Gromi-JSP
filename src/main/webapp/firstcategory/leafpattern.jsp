...
.btn-outlfine-secondary:focus:not(:active) {
	box-shadow: none;
}
</style>
</head>
		...
		<div class="row">
			<div class="col-md-12 text-center mb-5">
				<h1 class="fw-bold"
					...
					<span style="color: green; text-decoration: underline;">잎무늬</span>를
					찾고 있나요?
				</h1>
			</div>
			<div class="col-md-12 d-flex justify-content-center">
				<div class="d-flex justify-content-center">
					...
					<button
						...
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">줄무늬</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">점무늬</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">잎
						가장자리 무늬</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
	...
	<script>
		function toggleButton(button) {
			...
			if (button.classList.contains('active')) {
				...
				} else if (buttonText === '줄무늬') {
					window.location.href = '../plantview.jsp';
				} else if (buttonText === '점무늬') {
					window.location.href = '../plantview.jsp';
