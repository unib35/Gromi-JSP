		...
		<div class="row">
			<div class="col-md-12 text-center mb-5">
				<h1 class="fw-bold"
					...
					<span style="color: green; text-decoration: underline;">생육형태</span>를
					찾고 있나요?
				</h1>
			</div>
			<div class="col-md-12 d-flex justify-content-center">
				<div class="d-flex justify-content-center">
					...
					<button
						...
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">직립형</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">관목형</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">덩굴성</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">풀모양</button>
			...
			<div class="col-md-12 d-flex justify-content-center mt-3">
				<div class="d-flex justify-content-center">
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">로제트형</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">다육형</button>
					<button
						class="btn btn-primary btn-lg rounded-pill mx-2 custom-button"
						onclick="toggleButton(this)"
	...
	<script>
		function toggleButton(button) {
			...
			if (button.classList.contains('active')) {
				...
				} else if (buttonText === '직립형') {
					window.location.href = '../plantview.jsp';
				} else if (buttonText === '관목형') {
					window.location.href = '../plantview.jsp';
				} else if (buttonText === '덩굴성') {
					window.location.href = '../plantview.jsp';
				} else if (buttonText === '풀모양') {
					window.location.href = '../plantview.jsp';
				} else if (buttonText === '로제트형') {
					window.location.href = '../plantview.jsp';
				} else if (buttonText === '다육형') {
					window.location.href = '../plantview.jsp';
				}
			}
		}
