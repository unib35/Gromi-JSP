		...
		<div class="row">
			<div class="col-md-12 text-center mb-5">
				<h1 class="fw-bold"
					...
					<span style="color: green; text-decoration: underline;">꽃색</span>을
					찾고 있나요?
				</h1>
			</div>
			<div class="col-md-12 d-flex justify-content-center">
				<div class="d-flex justify-content-center">
					...
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">분홍색</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
			...
			<div class="col-md-12 d-flex justify-content-center mt-3">
				<div class="d-flex justify-content-center">
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">노랑색</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
					...
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
						style="border-color: gray; color: gray; font-size: 26px;">혼합색</button>
					<button
						class="btn btn-outline-secondary btn-lg rounded-pill mx-2 px-4 py-1"
						onclick="toggleButton(this)"
